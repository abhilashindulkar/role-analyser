    ...
    <div className="relative">
      <button
        ...
        className={`w-full text-left p-5 rounded-2xl border-2 transition-all ${
          selected
            ...
            : "bg-slate-50 dark:bg-dark-surface border-dashed border-slate-200 dark:border-dark-border hover:border-slate-300 dark:hover:border-slate-500"
        }`}
      >
        {selected ? (
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className={`font-bold text-base ${colors.text} dark:text-white break-words`}>
                {selected.title}
              </p>
      ...
      {open && (
        <>
          ...
          <div className="absolute top-full left-0 right-0 mt-2 bg-surface-raised dark:bg-dark-raised rounded-2xl border border-slate-200 dark:border-dark-border shadow-2xl z-50 overflow-hidden max-h-[400px] flex flex-col">
            <div className="p-3 border-b border-slate-100">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 text-sm border border-slate-200 dark:border-dark-border dark:bg-dark-surface dark:text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-400"
                  autoFocus
                />
              </div>
            </div>
  ...
  return (
    <div className="max-w-6xl mx-auto animate-fade-up">
      ...
      {comparison && roleA && roleB ? (
        ...
        <div className="bg-surface-raised dark:bg-dark-raised rounded-2xl border border-slate-200/80 dark:border-dark-border shadow-sm p-16 text-center">
